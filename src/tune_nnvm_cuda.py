...
def get_network(name, batch_size):
    ...
    if "resnet" in name:
        ...
        import coremltools
        coreml_model = coremltools.models.MLModel(os.path.join('../models', 'SqueezeNet_v1.1.mlmodel'))
...
def tune_and_evaluate(tuning_opt):
    ...
    print("Extract tasks...")
    net, params, input_shape, out_shape = get_network(network, batch_size=10)
